...
## [14.12.0] - 2026-01-31 — Текущая версия ✅
...
УРОВЕНЬ 10: ML-классификатор (37)
УРОВЕНЬ 12: ContextVerifier (70)
...
|------|--------|-----------|
| engine.py | **9.19.0** | Упрощены ранние слои, SafetyVeto в финале |
| safety_veto.py | **2.0.0** | Добавлен HARD_NEGATIVES |
| phonetic_semantic.py | **1.0.0** | НОВЫЙ: объединённые фонетико-семантические фильтры |
| cluster_analyzer.py | **1.1.0** | Добавлен check_merge_artifact() |
| filters/__init__.py | **8.5.0** | Обновлены экспорты |
...
- **Упрощение**: меньше слоёв, чище архитектура
- **Модульность**: фонетика+семантика в отдельном модуле
- **Прозрачность**: SafetyVeto показывает `VETO_xxx(was:reason)`
