...
| **v12.6.0** | 30.01 | **9.5.0** | 87 | 79 | 111 | 58 | 119 | **454** |
...
| **engine.py** | **v9.5.0** | **Фильтрация (27+ уровней) + context_verifier** |
| **context_verifier.py** | **v4.0** | **Контекстная верификация (4 уровня)** |
...
| Версия | Изменения |
|--------|-----------|
| **v12.6.0** | **Context Verifier v4.0 — 4 уровня контекстной фильтрации, -36 FP** |
